...
//void Math_MTSetSeed(int nSeed);
//void Math_MTSetSeedByCurrentTime(void);
//int Math_MTRand(void);
//float Math_MTRandF(void);
//float Math_MTRandFInclude1(void);
...
HLL_LIBRARY(Math,
	    ...
	    HLL_TODO_EXPORT(MTSetSeed, Math_MTSetSeed),
	    HLL_TODO_EXPORT(MTSetSeedByCurrentTime, Math_MTSetSeedByCurrentTime),
	    HLL_TODO_EXPORT(MTRand, Math_MTRand),
	    HLL_TODO_EXPORT(MTRandF, Math_MTRandF),
	    HLL_TODO_EXPORT(MTRandFInclude1, Math_MTRandFInclude1),

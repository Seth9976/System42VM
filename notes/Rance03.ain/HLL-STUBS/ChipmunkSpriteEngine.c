...
//void ChipmunkSpriteEngine_SYSTEM_SetConfigFrameSkipAllWhileMessageSkip(bool bConfigFrameSkipWhileMessageSkip);
...
HLL_LIBRARY(ChipmunkSpriteEngine,
	    ...
	    HLL_TODO_EXPORT(SYSTEM_SetConfigFrameSkipAllWhileMessageSkip, ChipmunkSpriteEngine_SYSTEM_SetConfigFrameSkipAllWhileMessageSkip),

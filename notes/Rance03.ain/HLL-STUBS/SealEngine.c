...
//void SealEngine_SetMagSpeed(int MagSpeed);
...
//bool SealEngine_GetInstanceAABB(int nPlugin, int nInstance, float *MinX, float *MinY, float *MinZ, float *MaxX, float *MaxY, float *MaxZ);
...
//bool SealEngine_SaveEffectAs(int nPlugin, int nInstance, struct string *FileName);
...
//bool SealEngine_Tool_GetInstanceIntParam(int Param, int PluginNumber, int InstanceNumber, int *Value);
//bool SealEngine_Tool_SetInstanceIntParam(int Param, int PluginNumber, int InstanceNumber, int Value);
//bool SealEngine_Tool_GetEmitterIntParam(int Param, int PluginNumber, int InstanceNumber, int EmitterNumber, int EmitterIndex, int *Value);
//bool SealEngine_Tool_SetEmitterIntParam(int Param, int PluginNumber, int InstanceNumber, int EmitterNumber, int EmitterIndex, int Value);
//bool SealEngine_Tool_GetEmitterFloatParam(int Param, int PluginNumber, int InstanceNumber, int EmitterNumber, int EmitterIndex, float *Value);
//bool SealEngine_Tool_SetEmitterFloatParam(int Param, int PluginNumber, int InstanceNumber, int EmitterNumber, int EmitterIndex, float Value);
//bool SealEngine_Tool_GetEmitterStringParam(int Param, int PluginNumber, int InstanceNumber, int EmitterNumber, int EmitterIndex, struct string **Value);
//bool SealEngine_Tool_SetEmitterStringParam(int Param, int PluginNumber, int InstanceNumber, int EmitterNumber, int EmitterIndex, struct string *Value);
//bool SealEngine_Tool_GetEmitterRandRangeParam(int Param, int PluginNumber, int InstanceNumber, int EmitterNumber, int EmitterIndex, float *Value);
//bool SealEngine_Tool_SetEmitterRandRangeParam(int Param, int PluginNumber, int InstanceNumber, int EmitterNumber, int EmitterIndex, float Value);
//bool SealEngine_Tool_Effect_AddEmitter(int PluginNumber, int InstanceNumber, int EmitterNumber);
//bool SealEngine_Tool_Effect_CopyEmitter(int PluginNumber, int InstanceNumber, int DestEmitterNumber, int SrcEmitterNumber);
//bool SealEngine_Tool_Effect_EraseEmitter(int PluginNumber, int InstanceNumber, int EmitterNumber);
//bool SealEngine_Tool_DetectPlaneCollision(int PluginNumber, int MouseX, int MouseY, float PlanePosX, float PlanePosY, float PlanePosZ, float PlaneVectorX, float PlaneVectorY, float PlaneVectorZ, float *CrossPosX, float *CrossPosY, float *CrossPosZ);
//bool SealEngine_Tool_Effect_DetectEmitterPosCollision(int PluginNumber, int InstanceNumber, int MouseX, int MouseY, int *pEmitterNumber, int *pPosNumber, int *pDetectAxis);
//bool SealEngine_Tool_GetMeshIntParam(int Param, int PluginNumber, int InstanceNumber, int MeshNumber, int *Value);
//bool SealEngine_Tool_SetMeshIntParam(int Param, int PluginNumber, int InstanceNumber, int MeshNumber, int Value);
//bool SealEngine_Tool_GetMeshFloatParam(int Param, int PluginNumber, int InstanceNumber, int MeshNumber, float *Value);
//bool SealEngine_Tool_SetMeshFloatParam(int Param, int PluginNumber, int InstanceNumber, int MeshNumber, float Value);
...
HLL_LIBRARY(SealEngine,
	    ...
	    HLL_TODO_EXPORT(SetMagSpeed, SealEngine_SetMagSpeed),
	    ...
	    HLL_TODO_EXPORT(SaveEffectAs, SealEngine_SaveEffectAs),
	    ...
	    HLL_TODO_EXPORT(Tool_GetInstanceIntParam, SealEngine_Tool_GetInstanceIntParam),
	    HLL_TODO_EXPORT(Tool_SetInstanceIntParam, SealEngine_Tool_SetInstanceIntParam),
	    HLL_TODO_EXPORT(Tool_GetEmitterIntParam, SealEngine_Tool_GetEmitterIntParam),
	    HLL_TODO_EXPORT(Tool_SetEmitterIntParam, SealEngine_Tool_SetEmitterIntParam),
	    HLL_TODO_EXPORT(Tool_GetEmitterFloatParam, SealEngine_Tool_GetEmitterFloatParam),
	    HLL_TODO_EXPORT(Tool_SetEmitterFloatParam, SealEngine_Tool_SetEmitterFloatParam),
	    HLL_TODO_EXPORT(Tool_GetEmitterStringParam, SealEngine_Tool_GetEmitterStringParam),
	    HLL_TODO_EXPORT(Tool_SetEmitterStringParam, SealEngine_Tool_SetEmitterStringParam),
	    HLL_TODO_EXPORT(Tool_GetEmitterRandRangeParam, SealEngine_Tool_GetEmitterRandRangeParam),
	    HLL_TODO_EXPORT(Tool_SetEmitterRandRangeParam, SealEngine_Tool_SetEmitterRandRangeParam),
	    HLL_TODO_EXPORT(Tool_Effect_AddEmitter, SealEngine_Tool_Effect_AddEmitter),
	    HLL_TODO_EXPORT(Tool_Effect_CopyEmitter, SealEngine_Tool_Effect_CopyEmitter),
	    HLL_TODO_EXPORT(Tool_Effect_EraseEmitter, SealEngine_Tool_Effect_EraseEmitter),
	    HLL_TODO_EXPORT(Tool_DetectPlaneCollision, SealEngine_Tool_DetectPlaneCollision),
	    HLL_TODO_EXPORT(Tool_Effect_DetectEmitterPosCollision, SealEngine_Tool_Effect_DetectEmitterPosCollision),
	    HLL_TODO_EXPORT(Tool_GetMeshIntParam, SealEngine_Tool_GetMeshIntParam),
	    HLL_TODO_EXPORT(Tool_SetMeshIntParam, SealEngine_Tool_SetMeshIntParam),
	    HLL_TODO_EXPORT(Tool_GetMeshFloatParam, SealEngine_Tool_GetMeshFloatParam),
	    HLL_TODO_EXPORT(Tool_SetMeshFloatParam, SealEngine_Tool_SetMeshFloatParam)
	    );

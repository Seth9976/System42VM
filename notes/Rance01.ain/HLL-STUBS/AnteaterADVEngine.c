...
//void AnteaterADVEngine_ADVLogList_AddText(struct string **pIText, int WindowNo);
//void AnteaterADVEngine_ADVLogList_AddNewLine(void);
//void AnteaterADVEngine_ADVLogList_AddNewPage(void);
//void AnteaterADVEngine_ADVLogList_AddVoice(int nVoiceNumber);
...
//void AnteaterADVEngine_ADVLogList_GetADVLogText(int nADVLog, int nText, struct string **pIText);
//int AnteaterADVEngine_ADVLogList_GetNumofADVLogVoice(int nADVLog);
//int AnteaterADVEngine_ADVLogList_GetADVLogVoice(int nADVLog, int Index);
